...
本项目来自 [YOUSTHEONE/FH6Auto](https://github.com/YOUSTHEONE/FH6Auto)。当前 V3.2 版本是在原项目基础上，针对现有游戏版本进行的本地维护、适配和功能优化。

## V3.2 for xbox/ms store更新重点

- 为xbox和微软商店用户适配，蓝图输入的等待逻辑回到了延时，现在 对应节点`Enter` 点击后会等待4s。
